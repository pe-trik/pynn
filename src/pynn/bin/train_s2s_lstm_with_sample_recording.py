...
from pynn.net.s2s_lstm import Seq2SeqWithSampleRecording
from pynn.bin import print_model, train_s2s_model_with_sample_recording
...
def create_model(args, device):
    ...
    model = Seq2SeqWithSampleRecording(**params)
...
def train(device, args):
    ...
    print_model(model)
    train_s2s_model_with_sample_recording(model, args, device)
...
def train_distributed(device, gpus, args):
    ...
    train_s2s_model_with_sample_recording(model, args, device, gpus)
